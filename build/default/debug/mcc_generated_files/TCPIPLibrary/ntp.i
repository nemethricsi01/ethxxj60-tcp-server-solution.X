# 1 "mcc_generated_files/TCPIPLibrary/ntp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/TCPIPLibrary/ntp.c" 2
# 39 "mcc_generated_files/TCPIPLibrary/ntp.c"
...
# 40 "mcc_generated_files/TCPIPLibrary/ntp.c" 2
...
# 41 "mcc_generated_files/TCPIPLibrary/ntp.c" 2
...
# 42 "mcc_generated_files/TCPIPLibrary/ntp.c" 2
...
# 43 "mcc_generated_files/TCPIPLibrary/ntp.c" 2
...
# 44 "mcc_generated_files/TCPIPLibrary/ntp.c" 2
...
# 45 "mcc_generated_files/TCPIPLibrary/ntp.c" 2
...
# 46 "mcc_generated_files/TCPIPLibrary/ntp.c" 2
...
# 47 "mcc_generated_files/TCPIPLibrary/ntp.c" 2
...
# 48 "mcc_generated_files/TCPIPLibrary/ntp.c" 2
...
void NTP_Request(void)
{
    ...
    ntpAddress = (ip_database_info.ipv4_ntpAddress[0]);
    myTime = time(0);
    myTime += 2208988800;
    ...
    if(ntpAddress != 0)
    {
        ...
        if(started == SUCCESS)
        {
            ...
            ETH_Write8(0x0A);
            ETH_Write8(0xEC);
            ETH_Write32(0x00003B68);
            ETH_Write32(0x00042673);
            ETH_Write32(ntpAddress);

            ETH_Write32((uint32_t)myTime);
            ETH_Write32(0x0000);
            ETH_Write32((uint32_t)myTime);
            ETH_Write32(0x0000);
            ETH_Write32((uint32_t)myTime);
...
void NTP_Handler(int16_t length)
{
    ...
    timeIntegralPart = ETH_Read32();
    timeFractionalPart = ETH_Read32();


    ETH_Read32();
    ETH_Read32();

    timeIntegralPart -= 2208988800;

    rtcc_set((time_t *)timeIntegralPart);
}
