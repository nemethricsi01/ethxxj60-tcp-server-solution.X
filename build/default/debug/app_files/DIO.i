...
# 1 "app_files/i2c_eeprom.h" 1
# 39 "app_files/i2c_eeprom.h"
void i2c_start(void);
void i2c_stop(void);
...
void DIO_Write(uint8_t value) {
    PORTAbits.RA2 = value & 0b1;
    PORTAbits.RA3 = (value & 0b10) >> 1;
    PORTAbits.RA4 = (value & 0b100) >> 2;
    PORTAbits.RA5 = (value & 0b1000) >> 3;
...
uint8_t DIO_Read(void) {
    uint8_t temp = 0;
    temp = PORTAbits.RA2;
    temp |= PORTAbits.RA3 << 1;
    temp |= PORTAbits.RA4 << 2;
    temp |= PORTAbits.RA5 << 3;
    return temp;
