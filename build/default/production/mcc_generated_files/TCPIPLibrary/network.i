...
# 59 "mcc_generated_files/TCPIPLibrary/network.c" 2
# 1 "mcc_generated_files/TCPIPLibrary/lldp_tlv_handler_table.h" 1
# 22 "mcc_generated_files/TCPIPLibrary/lldp_tlv_handler_table.h"
...
# 60 "mcc_generated_files/TCPIPLibrary/network.c" 2
...
# 61 "mcc_generated_files/TCPIPLibrary/network.c" 2
...
void Network_Manage(void)
{
    ...
    if(now > nowPv)
    {
        ...
        TCP_Update();
        LLDP_DecTTR();
        do{lldp_tx_timers.txTick=1;}while(0);
    }
    nowPv = now;
}
